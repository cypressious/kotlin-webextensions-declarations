 ...
 * @param size A number representing the width and height of the icon. Likely values include (but are not limited to) 128, 48, 24, and 16.
 * @param url The URL for this icon image. To display a grayscale version of the icon (to indicate that an extension is disabled, for example), append <code>?grayscale=true</code> to the URL.
 */
class IconInfo(
    var size: Int,
    var url: String
 ...
 * @param versionName The <a href='manifest/version#version_name'>version name</a> of this extension if the manifest specified one.
...
/**
 * @param showConfirmDialog Whether or not a confirm-uninstall dialog should prompt the user. Defaults to false.
 * @param dialogMessage The message to display to a user when being asked to confirm removal of the extension.
 */
class Options2(
